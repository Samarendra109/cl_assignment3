...
p1 :- (prec([a,language,speaks,a,language]); true), (write('\n'),nl).
p2 :- (prec([a,language,speaks,a,hacker]); true), (write('\n'),nl).
p3 :- (prec([a,hacker,speaks,a,language]); true), (write('\n'),nl).
p4 :- (prec([a,hacker,speaks,a,hacker]); true), (write('\n'),nl).

p5 :- (prec([every,language,speaks,a,language]); true), (write('\n'),nl).
p6 :- (prec([every,language,speaks,a,hacker]); true), (write('\n'),nl).
p7 :- (prec([every,hacker,speaks,a,language]); true), (write('\n'),nl).
p8 :- (prec([every,hacker,speaks,a,hacker]); true), (write('\n'),nl).

p9 :- (prec([every,language,speaks,every,language]); true), (write('\n'),nl).
pA :- (prec([every,language,speaks,every,hacker]); true), (write('\n'),nl).
pB :- (prec([every,hacker,speaks,every,language]); true), (write('\n'),nl).
pC :- (prec([every,hacker,speaks,every,hacker]); true), (write('\n'),nl).

pD :- (prec([a,language,speaks,every,language]); true), (write('\n'),nl).
pE :- (prec([a,language,speaks,every,hacker]); true), (write('\n'),nl).
pF :- (prec([a,hacker,speaks,every,language]); true), (write('\n'),nl).
pG :- (prec([a,hacker,speaks,every,hacker]); true), (write('\n'),nl).

q1 :- (prec([a,language,a,language,speaks]); true), (write('\n'),nl).
q2 :- (prec([a,hacker,a,language,speaks]); true), (write('\n'),nl).
q3 :- (prec([a,language,a,hacker,speaks]); true), (write('\n'),nl).
q4 :- (prec([a,hacker,a,hacker,speaks]); true), (write('\n'),nl).

q5 :- (prec([a,language,every,language,speaks]); true), (write('\n'),nl).
q6 :- (prec([a,hacker,every,language,speaks]); true), (write('\n'),nl).
q7 :- (prec([a,language,every,hacker,speaks]); true), (write('\n'),nl).
q8 :- (prec([a,hacker,every,hacker,speaks]); true), (write('\n'),nl).

q9 :- (prec([every,language,every,language,speaks]); true), (write('\n'),nl).
qA :- (prec([every,hacker,every,language,speaks]); true), (write('\n'),nl).
qB :- (prec([every,language,every,hacker,speaks]); true), (write('\n'),nl).
qC :- (prec([every,hacker,every,hacker,speaks]); true), (write('\n'),nl).

qD :- (prec([every,language,a,language,speaks]); true), (write('\n'),nl).
qE :- (prec([every,language,a,language,speaks]); true), (write('\n'),nl).
qF :- (prec([every,language,a,hacker,speaks]); true), (write('\n'),nl).
qG :- (prec([every,hacker,a,hacker,speaks]); true), (write('\n'),nl).
